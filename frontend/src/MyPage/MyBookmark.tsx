...
import { CocktailDetailType, CocktailItemType, fetchCustomCocktailList, fetchStandardCocktailList, selectCocktail } from "../store/slices/cocktail/cocktail"
...
const MyBookmark = () => {
    ...
    const dummyCocktails: Pick<CocktailItemType, "image" | "name" | "rate" | "id" | "type">[] =
        [{
            id: 1,
            name: 'name',
